/*False Wire Class for LGS Project */
import javax.swing.*;
import java.awt.*;
...
{
   //Constructor
   public FALSE(int num_in)
   {
      super(num_in,gatetype.FALSE);
...
if(!validWires)
      ...
      //Label this as a false gate to differentiate from input
      g.setFont(new Font("TimesRoman", Font.PLAIN, 20));
      g.drawString("FALSE",(xStart + ((xFinish-xStart)/2) - 30), (yStart + ((yFinish-yStart)/2) + 10));
